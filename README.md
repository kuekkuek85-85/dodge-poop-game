...
|---|---|---|
| 가만히 서 있기 | 7.7초 | 83점 |
| 아무렇게나 움직이기 | 17.1초 | 224점 |
| 닥치면 피하기 | 40.9초 | 777점 |
| 조금 앞을 읽기 | 5.5분 | 12882점 |
| 배치를 외움 | **9.9분** | **24135점** |

처음과 끝의 차이가 **290배**다. 오래 붙잡고 있을수록 계속 올라갈 여지가 있다.
...
> 레벨 8의 16개까지 오른 뒤 하한에 걸려 고정된다.

> 배치가 고정이므로 "여러 판의 분포"가 아니라 **한 판에서 실력별로 얼마나
> 가느냐**가 기준이다. 위 실력 사다리 참고 — 처음 8초, 익숙해지면 41초,
> 외우면 10분. 실제 1학년 수치는 태블릿으로 몇 판 해 본 뒤 조정한다.
